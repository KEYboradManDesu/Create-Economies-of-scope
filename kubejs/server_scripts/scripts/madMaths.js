...
//编程拼图
event.recipes.createCrushing([Item.of(PC('programming_puzzle', 4)), Item.of(PC('programming_puzzle', 2)).withChance(.45)], MEK('basic_control_circuit')).processingTime(250)
event.recipes.createCrushing([Item.of(PC('programming_puzzle', 12)), Item.of(PC('programming_puzzle', 4)).withChance(.45)], MEK('advanced_control_circuit')).processingTime(250)
event.recipes.createCrushing([Item.of(PC('programming_puzzle', 24)), Item.of(PC('programming_puzzle', 8)).withChance(.45)], MEK('elite_control_circuit')).processingTime(250)
event.recipes.createCrushing([Item.of(PC('programming_puzzle', 48)), Item.of(PC('programming_puzzle', 16)).withChance(.45)], MEK('ultimate_control_circuit')).processingTime(250)
event.recipes.createCrushing([Item.of(PC('programming_puzzle', 1))], KJ('missingno')).processingTime(30)
//
...
let types = ["three", "eight", "plus", "minus", "multiply", "divide"]
	...
	meltOrCrucible(PC("programming_puzzle"), KJ("programming"), 15)
