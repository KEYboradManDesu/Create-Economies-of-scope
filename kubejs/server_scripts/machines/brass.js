...
//红石浇筑
event.recipes.createFilling(TE("rf_coil"), ['#forge:rods/gold', Fluid.of(TE('redstone'), 200)])
...
redstoneTransmute('createaddition:gold_rod', TE("rf_coil"), "casting_table", 200)
...
event.shaped(PR_C('screwdriver'), [
	...
	S: 'createindustry:aluminum_ingot',
	B: 'create_dd:lapis_alloy'
})
...
event.recipes.createSplashing([//黑沙
	Item.of(MC('clay_ball')).withChance(0.25)
